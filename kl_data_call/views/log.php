    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table_b">
        ...
        <tr>
            ...
            <td>
                ...
                <span style="color:green;"> * 此选项可以填入要调用的<strong>文章id</strong>,用<strong>半角的逗号(,)</strong>分隔即可，如(20,15,16,25)。</span>
        ...
        <tr>
            ...
            <td><select name="sort" id="sort">
                ...
                　　　　　　<label><input id="include_child_sort" name="include_child_sort" type="checkbox" value="1" <?php if (isset($module['include_child_sort']) && $module['include_child_sort'] == 1) echo 'checked'; ?>/>包含子类<span style="color:orange;">(当选择某个特定的分类时有效)</span></label>
            </td>
        </tr>
        <tr>
            <td align="left">作者：</td>
