...
<form action="./plugin.php?plugin=kl_data_call&action=setting&act=<?php echo $act; ?>" method="POST">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table_b">
        ...
        <tr>
            <td align="left">相册：</td>
            <td><select id="em_album" name="em_album"><?php echo $kl_album_option_str; ?></select></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input id="preview_do" type="button" value="预览"/>
                <input type="submit" value="确认提交"/><input type="hidden" id="ajaxUrl" name="ajaxUrl" value="<?php echo BLOG_URL; ?>content/plugins/kl_data_call/kl_data_call_preview.php">
            </td>
        </tr>
    </table>
</form>