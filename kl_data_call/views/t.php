...
<form action="./plugin.php?plugin=kl_data_call&action=setting&act=<?php echo $act; ?>" method="POST">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table_b">
        ...
        <tr>
            ...
            <td>自增ID{auto_id}, 微语内容{content}, 时间{date}, 作者{author}, 回复数{replaynum},
                <br/>微语中的图片地址(缩略){thum_imageurl}, 微语中的图片地址(原图){imageurl}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input id="preview_do" type="button" value="预览"/>
                <input id="save" type="submit" value="确认提交"/><input type="hidden" id="ajaxUrl" name="ajaxUrl" value="<?php echo BLOG_URL; ?>content/plugins/kl_data_call/kl_data_call_preview.php">
            </td>
        </tr>
    </table>
</form>